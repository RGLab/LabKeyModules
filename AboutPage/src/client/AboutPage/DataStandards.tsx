  ...
  return (
    <div id="DataStandards-content">
      <p>
        ...
        experimental results to NIAID/ImmPort. Most of the standards we develop
        are incorporated into the ImmPort data deposition templates. All HIPC
        centers submit data directly to ImmPort using the templates available on
        the{" "}
      ...
      <ul>
        <li>
          ...
          ImmPort, HIPC requires submission of the underlying data to NCBI. For
          details, please see{" "}
        ...
        <li>
          ...
          . In addition to raw data in .fcs files, HIPC requires the submission
          of derived data (e.g., the cell population frequencies). For CyTOF and
          flow cytometry, these are submitted using the associated derived data
        ...
        <li>
          ...
          using the control sample and standard curve templates available on the{" "}
          <a href="http://www.immport.org/immport-open/public/home/dataTemplates">
            ImmPort Website
          </a>
          .
        ...
        <li>
          ...
          <p>
            <a href="https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-019-2725-5">
              James A. Overton JA, Vita R, Dunn P, Burel JG, Bukhari SAC, Cheung
              KH, Kleinstein SH, Diehl AD, Peters B. (2019) Reporting and
              connecting cell type names and gating definitions through
        ...
        <li>
          ...
          <p>
            <a href="http://ceur-ws.org/Vol-2285/ICBO_2018_paper_41.pdf">
              Vita R, Overton JA, Cheung KH, Kleinstein SH, Peter B. Proceedings
              of the 9th International Conference on Biological Ontology (ICBO
