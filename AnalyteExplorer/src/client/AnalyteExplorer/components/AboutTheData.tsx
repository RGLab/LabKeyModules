...
export const AboutTheData: React.FC = () => {
  return (
    <p>
      Analyte Explorer currently supports gene expression data for genes, and blood 
      transcription modules (BTMs) published by <a href="https://www.nature.com/articles/ni.2789"> 
      Li et al. </a> Gene metadata is pulled from <a href="https://mygene.info/"> 
