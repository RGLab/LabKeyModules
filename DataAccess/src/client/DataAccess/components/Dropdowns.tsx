...
export const OuterDropdownButton: React.FC<OuterDropdownButtonProps> = ({children, disabled, title, id, onClick}) => {
    ...
    return (
        <div className="dropdown df-outer-dropdown" id={id}>
            <div className={"btn"} ref={openRef} role="group" >
                <button className="btn btn-default dropdown-toggle" type="button" disabled={disabled} onClick={() => {onClick(); open()}}>
                    <span>{title}</span>
