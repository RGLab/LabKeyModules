...
if(timeAs == "observation"){
    ...
    print("Plots are only labelled by timepoint if `Use Time As` equals 'observation'.")
}
...
if(sdy == "/Studies"){
   ...
   print("Plots are only labelled by study if run at the project level through `Data Finder`.")
}
```
<script>
