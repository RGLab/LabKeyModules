...
dimReduxPath <- paste0("/share/files/Studies/", sdy, "/@files/cache/DimensionReduction/")
if (!dir.exists(dimReduxPath)) {
  dir.create(dimReduxPath)
}
rdaPath <- paste0(dimReduxPath, labkey.user.email)

if (label == "age_reported"){
...
```{r, cleanup}
if( (timeAs == "variable" & label == "gender") | (timeAs == "observation" & label == "time") ){
