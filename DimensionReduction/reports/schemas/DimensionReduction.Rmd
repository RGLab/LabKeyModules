...
div(id = "plots",
    div(
          ...
          # Dropdown menu -----------------
      div(class = "btn-group",
          tags$button(class = "dropdown-toggle",
                      "data-toggle" = "dropdown",
                      "Select Plot Type",
                      span(class = "caret")),
          tags$ul(class = "dropdown-menu",
                  tags$li(class = "active",
                          tags$a(href = paste0("#",names(plotInfo[[1]]$label)),
                                 "data-toggle" = "tab",
                                 plotInfo[[1]]$name)),
                  tagList(
                    lapply(plotInfo[-1],
      ...
      div(class = "tab-content",
          div(id = plotInfo[[1]]$label, class = "tab-pane active",
              h2(plotInfo[[1]]$name),
              makePlot(label = plotInfo[[1]]$label,
                       aggregateBy = aggregateBy,
                       demog = demog,
