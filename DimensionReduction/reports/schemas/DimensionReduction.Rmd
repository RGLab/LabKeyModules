...
```{r helper-fn}
getAssayData <- function(assay, con, filteredPids, timePts, timeAs){
...
}else if(dim(allMat)[1] < 2){
  stop("R Report Error: Fewer than two subjects with complete cases. Select imputation method other than 'None' and retry.")
}
```
