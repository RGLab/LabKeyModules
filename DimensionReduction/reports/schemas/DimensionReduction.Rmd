...
labkey.url.params <- list(
  ...
  "assays"="gene_expression_files,fcs_analyzed_result",
  "responseVar"="hai",
  "plotType"="PCA",
  "impute"="mean",
  "perplexity"="5",
...
if (impute != "none") {
  missingFeaturesBySubject <- lapply(aData, function(dt){
...
`r if (projLvl) {"### Sample Type"}`
```{r Sample, fig.align="left", eval = projLvl}
