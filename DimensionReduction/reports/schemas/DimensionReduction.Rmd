...
plotInfo <- list(list(plot = TRUE, name = "Age", label = "age_reported"),
                 ...
                 list(plot = projLvl & "gene_expression_files" %in% assays, name = "Feature Annotation Set", label = "fasName"),
                 list(plot = projLvl & "gene_expression_files" %in% assays, name = "FAS Vendor", label = "fasVendor"),
