...
ems <- rjson::fromJSON(labkey.url.params$ema)
input_cohorts <- rjson::fromJSON(labkey.url.params$cohorts)
input_genes <- rjson::fromJSON(labkey.url.params$genes)
...
# Data grid
filters <- rjson::fromJSON(labkey.url.params$filters)
