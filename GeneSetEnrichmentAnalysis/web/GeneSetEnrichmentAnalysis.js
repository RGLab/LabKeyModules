...
LABKEY.ext.GeneSetEnrichmentAnalysis = Ext.extend(Ext.Panel, {
  constructor: function (config) {
    ...
    var checkBtnsStatus = function () {
      if (cbModules.isValid(true) && cbCohort.isValid(true)) {
      ...
      if (
        cbModules.getValue() == cbModules.originalValue &&
      ...
      store: new Ext.data.ArrayStore({
        data: [
          [
            "Blood transcription",
            "Blood transcription",
            "Set of transcription modules in blood.",
          ],
          [
            "MSigDB c7",
            "MSigDB c7",
    ...
    var cnfReport = {
      ...
      reportId:
        "module:GeneSetEnrichmentAnalysis/GeneSetEnrichmentAnalysis.Rmd",
      success: function (result) {
        ...
        if (errors && errors.length > 0) {
          ...
          if (LABKEY.ActionURL.getContainer() !== "/Studies") {
            cntShare.setVisible(true);
          }
        ...
        new Ext.Container({
          ...
          listeners: {
            afterrender: {
              fn: function () {
                this.getEl().on("click", function () {
                  LABKEY.help.Tour.show("immport-gsea-tour");
                });
              },
              single: true,
            },
    ...
    var pnlTabs = new Ext.TabPanel({
      ...
      listeners: {
        afterrender: {
          fn: function () {
            maskReport = new Ext.LoadMask(this.getEl(), {
          ...
          if (e) {
            if (e.findRecord(e.valueField, v)) {
              ...
              e.markInvalid(
                '"' +
                  v +
                  '" in the supplied URL is not a valid value, select from the available choices'
              );
            }
          }
        });
    ...
    var setReportRunning = function (bool) {
      ...
      Ext.each([cbCohort, cbModules, btnRun, btnReset, cntShare], function (e) {
        e.setDisabled(bool);
      });
    };
    ...
    $("#" + config.webPartDivId)
      ...
      .wrap(
        "<a href='" +
          LABKEY.ActionURL.buildURL("reports", "runReport", null, {
            reportId:
              "module:GeneSetEnrichmentAnalysis/reports/schemas/GeneSetEnrichmentAnalysis.Rmd",
            tabId: "Source",
          }) +
    ...
    LABKEY.ext.GeneSetEnrichmentAnalysis.superclass.constructor.apply(
      this,
      arguments
    );
  }, // end constructor
