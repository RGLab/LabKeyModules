...
AND GEA.expression_matrix_accession = GEM.expression_matrix_accession
AND GEA.description like CONCAT(CONCAT('%', SUBSTRING(CONVERT(GEM.study_time_reported, VARCHAR), 1, 1)), '%')
AND GEM.study_time_reported > 0
