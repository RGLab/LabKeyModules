...
```{r envir-var}
param <- list(
    timepoint   = as.numeric( labkey.url.param$timePoint ),
    GEA_acc     = labkey.url.param$analysisAccession,
    EM_acc      = labkey.url.param$expressionMatrixAccession,
    FDR_thresh  = 0.02, # as.numeric( labkey.url.param$fdrThreshold ),
    FC_thresh   = 0     # as.numeric( labkey.url.param$fcThreshold )
)
```
