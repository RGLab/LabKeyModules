...
```{r print}
print(paste0(
    '<a href="http://immunet-dev.princeton.edu/predictions/gene/?network=hipc_flu&gene=',
     unlist(strsplit(selected_features, split=";")), '" target="_blank">', unlist(strsplit(selected_features, split=";")), '</a>'))
```
...
if(param$gene_avg){
  ...
  predictor_table <- predictor_table[, gene_symbol:=paste0( paste0(
    '<a href="http://immunet-dev.princeton.edu/predictions/gene/?network=hipc_flu&gene=',
     unlist(strsplit(as.character(selected_features), split=";")), '" target="_blank">', unlist(strsplit(as.character(selected_features), split=";")), '</a>'), collapse=";")]
} else{
  ...
  predictor_table <- predictor_table[, gene_symbol:=paste0(
   '<a href="http://immunet-dev.princeton.edu/predictions/gene/?network=hipc_flu&gene=',
   gsub(";","%2C", predictor_table[,gene_symbol]),'" target="_blank">', predictor_table[,gene_symbol], '</a>')]
}
```
