...
param <- list(
    ...
    cohortTrain = RJSONIO::fromJSON( labkey.url.params$cohortTraining ), # NEW
    ...
    cohortTest  = RJSONIO::fromJSON( labkey.url.params$cohortTesting ), # NEW
    gene_avg	= labkey.url.params$individualProbesFlag # NEW
)
```
...
<h2>  Prediction </h2>
```{r prediction, hfig.cap=TRUE, fig.cap="Figure 2. Predicted vs. observed values for the prediction model."}
