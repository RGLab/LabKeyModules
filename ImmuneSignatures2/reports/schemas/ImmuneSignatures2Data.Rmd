...
### Manuscript Figures
[**Reproduction of manuscript figures**](/_webdav/HIPC/IS2/%40files/html_outputs/prevax.html){target="_blank"}
...
1. [Pull Expressionsets](/_webdav/HIPC/IS2/%40files/html_outputs/pull_esets.html){target="_blank"}
    * Pulls gene expression data from ImmuneSpace server, constructs expressionsets,
    and saves output to an R object on disk.
1. [Generate Base ExpressionSet](/_webdav/HIPC/IS2/%40files/html_outputs/generate_base_eset.html){target="_blank"}
    * Perform basic QC and filtering, and save output to one ExpressionSet.
1. [Create Final ExpressionSets](/_webdav/HIPC/IS2/%40files/html_outputs/create_final_esets.html){target="_blank"}
