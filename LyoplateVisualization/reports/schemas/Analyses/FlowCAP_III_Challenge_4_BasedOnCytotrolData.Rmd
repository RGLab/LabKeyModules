...
the two algorithms were combined as an OpenCyto pipeline, which was then used to analyze the Seracare data. A report peforming the automated gating for all panels can be found [here](/reports/HIPC/Lyoplate/runReport.view?reportId=db%3A158&redirectUrl=%2Fproject%2FHIPC%2FLyoplate%2Fbegin.view%3FpageId%3DAnalyses). The evaluation of the results 
...
ggplot(cb)+
  ...
  scale_color_brewer(type="qual")+ggtitle("Bias for B-cell Panel")+xlim(c(0,0.5))
