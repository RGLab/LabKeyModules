...
logs_dt <- lapply(from_to$date, read_log2) %>% bind_rows()
```


## Pageviews: Study
```{r study-views}
string <- "(/project/Studies/SDY\\d+/begin.view\\?? | /project/Studies/begin.view\\?? | /project/HIPC/IS\\d+/begin.view\\?? | /project/HIPC/Lyoplate/begin.view\\??)"
...
## Pageviews: Module
```{r module-views}
string <- "(?<=GET /)(DataExplorer|GeneExpressionExplorer|GeneSetEnrichmentAnalysis|ImmuneResponsePredictor)(?=/\\w+)"
