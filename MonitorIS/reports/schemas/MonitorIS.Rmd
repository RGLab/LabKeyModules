...
# Group by break
tmp <- as.POSIXct(ISR_user$date2, format="%Y-%m-%d", tz="UTC")
ISR_usersOverTime <- ISR_user[ , Date := as.Date(cut(tmp, breaks = labkey.url.params$by)) ]
...
# prep ISR Logins
ISR_logins <- ISR_user[ , list(Date, X12)]
