...
exclusion_email <- unique(c(admins$Email, extras$Email), "rsautera@fhcrc.org")
```
...
ISR_inits <- ISR %>%
  filter(query == "ISC_study_datasets" |
         X5 == "GET /project/Studies/getContainers.view?includeSubfolders=0&includeEffectivePermissions=1 HTTP/1.1",
         X1 != "10.10.1.74")
```
