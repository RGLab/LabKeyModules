...
## 20. Publications & Citations
These are a list of publications that cite publications listed in ImmuneSpace Studies.  The "original" columns refer to the publication listed in
ImmuneSpace and the "citedby" refers to the publications which cite ImmuneSpace-related studies.
```{r organizing-pub-data}
allIds <- getCurrentRDS("pubmedInfo")
datatable(allIds)
```

## 21. Google Analytics Data
```{r google-analytics}
...
gaData$shortDate <- format(as.Date(gaData$date), "%Y-%b")
