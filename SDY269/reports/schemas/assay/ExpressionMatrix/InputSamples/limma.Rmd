# Differential expression analysis for all cohorts at all timepoints

In this report, we perform a differential expression analysis for all cohorts at day 3 and 7. The results are then stored in the database. 

```{r envir-test-var, echo = FALSE}
...
opts_chunk$set(cache=FALSE, cache.path=file.path(labkey.file.root, "cache/limma_analysis_08/"))
options(width=80)
```
