...
LABKEY.ext.StudyOverview = Ext.extend( Ext.Panel, {
    ...
    constructor : function(config) {                                                                                                       
        var
            ...
            initialHTML =
                ...
                '<span id=\'immport' + config.webPartDivId + '\'></span>'
        ;

        $('#' + config.webPartDivId).append(
            '<div id=\'StudyOverview' + config.webPartDivId + '\'>' + initialHTML + '</div>'
        );
...
'<a href=\'https://immport.niaid.nih.gov/immportWeb/clinical/study/displayStudyDetails.do?itemList=' + SDY + '\' title=\'' + SDY + ' on ImmPort\'>'+ SDY +'</a>'
        ...
        function onSuccessStudy(results) {
            if ( results.rows.length > 0 ){
                ...
                $('#description' + config.webPartDivId)[0].innerHTML    = row['description'].value;
                $('#objective' + config.webPartDivId)[0].innerHTML      = row['objectives'].value;
        ...
        me.border         = false;                                                                                                         
        me.cls            = 'ISCore';
        me.contentEl      = 'StudyOverview' + config.webPartDivId;
        me.frame          = false;
        me.layout         = 'fit';
        ...
        LABKEY.ext.StudyOverview.superclass.constructor.apply(this, arguments);
    } // end constructor
